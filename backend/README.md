...
## Project Structure
    ...
    ├── testapiautosetting_127302  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127302`
...
2. Clone this repo and `cd testapiautosetting_127302`
